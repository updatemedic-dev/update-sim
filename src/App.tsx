          ...
          <div className="flex h-[192px] gap-1.5 p-1.5">
            ...
            <div className="flex flex-col p-2 flex-1 min-w-[200px] rounded-xl bg-gradient-to-b from-[#1a1a28] to-[#111120] border border-gray-800 shadow-[0_2px_8px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.03)]">
              ...
              <button onClick={() => { defib.disarm(); audioEngine.stopChargedBeep(); }}
                className="mt-3 py-5 rounded-xl text-lg font-bold text-white border-2 border-cyan-600 bg-gradient-to-b from-cyan-600 to-cyan-900 shadow-[0_3px_6px_rgba(0,0,0,0.5),inset_0_2px_0_rgba(255,255,255,0.1)] hover:from-cyan-500 hover:to-cyan-800 active:translate-y-[1px] transition-all">
                {t('disarm', language)}
              </button>
            </div>
          </div>

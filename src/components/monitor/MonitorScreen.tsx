      ...
      <div className="flex items-center h-[76px] px-4 border-b border-gray-800 shrink-0 bg-[#0a0a0a]">
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M12 15a3 3 0 100-6 3 3 0 000 6z" stroke="#9ca3af" strokeWidth="1.5"/>
            <path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke="#9ca3af" strokeWidth="1.5"/>
          </svg>
        </button>
        {/* Clock */}
        ...
        <div className="flex items-center gap-2" style={{ marginLeft: 24 }}>
          ...
          >
            <svg width="24" height="20" viewBox="0 0 16 14" fill="none">
              <path d="M8 1L2 7L8 13" stroke="#9ca3af" strokeWidth="2.5" strokeLinejoin="round"/>
              <path d="M15 1L9 7L15 13" stroke="#9ca3af" strokeWidth="2.5" strokeLinejoin="round"/>
            </svg>
          </button>
          ...
          >
            {isPaused || isStopped ? (
              <svg width="22" height="24" viewBox="0 0 14 16" fill="none">
                <path d="M2 1L13 8L2 15V1Z" fill="#9ca3af"/>
              </svg>
            ) : (
              <svg width="20" height="24" viewBox="0 0 12 16" fill="none">
                <rect x="1" y="1" width="3.5" height="14" rx="0.5" fill="#9ca3af"/>
                <rect x="7.5" y="1" width="3.5" height="14" rx="0.5" fill="#9ca3af"/>
              </svg>
            )}
          </button>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 14 14" fill="none">
              <rect x="2" y="2" width="10" height="10" rx="1" fill="#9ca3af"/>
            </svg>
          </button>
          ...
          >
            <svg width="24" height="20" viewBox="0 0 16 14" fill="none">
              <path d="M1 1L7 7L1 13" stroke="#9ca3af" strokeWidth="2.5" strokeLinejoin="round"/>
              <path d="M8 1L14 7L8 13" stroke="#9ca3af" strokeWidth="2.5" strokeLinejoin="round"/>
            </svg>
          </button>

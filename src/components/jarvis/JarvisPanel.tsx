...
export default function JarvisPanel() {
  ...
  return (
    <div className="jarvis-panel" style={{ '--jarvis-color': color } as React.CSSProperties}>
      ...
      <div className="jarvis-clinical-banner">
        [VALIDAR CON EXPERTO CLÍNICO] {es ? 'Solo simulación. No usar en pacientes reales.' : 'Simulation only. Do not use on real patients.'}
      </div>

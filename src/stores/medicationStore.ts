...
const DEFAULT_MEDICATIONS: Medication[] = [
  ...
  { id: "epinephrine_ped", name: "Epinephrine Ped (0.01mg/kg)", nameEs: "Epinefrina Ped (0.01mg/kg)", category: MedicationCategory.PEDIATRIC, defaultDose: "0.01mg/kg IV/IO", route: "IV/IO", color: "#f87171" },
